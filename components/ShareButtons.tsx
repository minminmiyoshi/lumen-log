...
export default function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  return (
    <div className="my-8">
      <p className="text-sm text-[var(--color-muted)] mb-3">この記事をシェアする</p>
      <div className="flex flex-wrap gap-3">
        ...
        <a
          ...
          aria-label="Xでシェア"
          className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-white bg-black hover:opacity-80 transition-opacity"
        >
          <XIcon />
          <span>ポストする</span>
        </a>
        ...
        <a
          ...
          rel="noopener noreferrer"
          aria-label="LINEでシェア"
          className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-white bg-[#06C755] hover:opacity-80 transition-opacity"
        >
          <LineIcon />
          <span>LINEで送る</span>
        </a>
        ...
        <a
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-white bg-[#00A4DE] hover:opacity-80 transition-opacity"
        >
          <HatenaIcon />
          <span>ブックマーク</span>
        </a>
        ...
        <a
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-white bg-[#1877F2] hover:opacity-80 transition-opacity"
        >
          <FacebookIcon />
          <span>シェア</span>
        </a>
